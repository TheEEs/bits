...
})({"4PXI3":[function(require,module,exports) {
"use strict";
...
var _indexVue = require("./Index.vue");
var _indexVueDefault = parcelHelpers.interopDefault(_indexVue);
const app = (0, _vue.createApp)((0, _indexVueDefault.default));
app.mount("#app");

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"b9ECB","./Index.vue":"cb2rN"}],"gzxs9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@vue/runtime-dom":"9wNvI","@parcel/transformer-js/src/esmodule-helpers.js":"b9ECB"}],"9wNvI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@vue/runtime-core":"lmqBl","@vue/shared":"3SM3y","@parcel/transformer-js/src/esmodule-helpers.js":"b9ECB"}],"lmqBl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@vue/reactivity":"d7UXQ","@vue/shared":"3SM3y","@parcel/transformer-js/src/esmodule-helpers.js":"b9ECB"}],"d7UXQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@vue/shared":"3SM3y","@parcel/transformer-js/src/esmodule-helpers.js":"b9ECB"}],"3SM3y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"b9ECB"}],"b9ECB":[function(require,module,exports) {
...
},{}],"cb2rN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    ...
    script.__scopeId = "data-v-35eedf";
    script.__file = "/home/trdt_74/bits/src/Index.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "35eedf-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("35eedf-hmr", script)) __VUE_HMR_RUNTIME__.reload("35eedf-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"custom:./Index.vue":"3M4M5","@parcel/transformer-js/src/esmodule-helpers.js":"b9ECB","template:./Index.vue":"5IPw4","script:./Index.vue":"aB2gq"}],"3M4M5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"b9ECB"}],"5IPw4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
const _hoisted_1 = {
    class: "h-screen w-full flex items-center justify-center font-mono text-xl"
};
const _hoisted_2 = {
    id: "bitsA",
...
const _hoisted_5 = /*#__PURE__*/ (0, _vue.createElementVNode)("option", {
    value: "and"
}, "AND", -1 /* HOISTED */ );
...
const _hoisted_12 = /*#__PURE__*/ (0, _vue.createElementVNode)("div", {
    id: "line",
    class: "border-2 border-slate-600 mt-6 mb-4"
}, null, -1 /* HOISTED */ );
const _hoisted_13 = {
    id: "bitC",
    class: "text-3xl cursor-default"
};
const _hoisted_14 = {
    class: "text-sm font-normal"
};
    ...
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_1, [
        (0, _vue.createElementVNode)("div", null, [
            (0, _vue.createElementVNode)("section", _hoisted_2, [
                ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($setup.bitsA, (i, k)=>{
                    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("span", {
                        onClick: ($event)=>$setup.bitsA[k] = Math.abs(i - 1),
                        key: `bitA${k}`
                    }, (0, _vue.toDisplayString)($setup.bit(i)), 9 /* TEXT, PROPS */ , _hoisted_3);
                }), 128 /* KEYED_FRAGMENT */ ))
            ]),
            (0, _vue.createElementVNode)("strong", _hoisted_4, "(" + (0, _vue.toDisplayString)($setup.decA) + ")", 1 /* TEXT */ ),
            (0, _vue.createElementVNode)("div", null, [
                (0, _vue.withDirectives)((0, _vue.createElementVNode)("select", {
                    class: "py-4",
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event)=>$setup.operator = $event),
                    name: "operator",
                    id: ""
            ...
            (0, _vue.createElementVNode)("section", _hoisted_9, [
                ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($setup.bitsB, (i, k)=>{
                    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("span", {
                        onClick: ($event)=>$setup.bitsB[k] = Math.abs(i - 1),
                        key: `bitB${k}`
                    }, (0, _vue.toDisplayString)($setup.bit(i)), 9 /* TEXT, PROPS */ , _hoisted_10);
                }), 128 /* KEYED_FRAGMENT */ ))
            ]),
            (0, _vue.createElementVNode)("strong", _hoisted_11, "(" + (0, _vue.toDisplayString)($setup.decB) + ")", 1 /* TEXT */ ),
            _hoisted_12,
            (0, _vue.createElementVNode)("section", _hoisted_13, [
                ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($setup.result, (i, k)=>{
                    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("span", {
                        key: `bitC${k}`
                    }, (0, _vue.toDisplayString)($setup.bit(i)), 1 /* TEXT */ );
                }), 128 /* KEYED_FRAGMENT */ ))
            ]),
            (0, _vue.createElementVNode)("strong", _hoisted_14, "(" + (0, _vue.toDisplayString)($setup.decC) + ")", 1 /* TEXT */ ),
            (0, _vue.createElementVNode)("button", {
                onClick: $setup.moveToA,
                class: "float-right px-2 py-3 bg-sky-500 mt-4 font-normal text-sm text-slate-100 border-b-2 border-b-sky-700 active:border-b-0"
            }, "Copy to A")
        ])
    ]);
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("35eedf-hmr", render);
});

},{"@parcel/transformer-js/src/esmodule-helpers.js":"b9ECB","vue":"gzxs9"}],"aB2gq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _vue = require("vue");
exports.default = {
    ...
    setup (__props, { expose  }) {
        ...
        const operator = (0, _vue.ref)("and");
        const result = (0, _vue.computed)(()=>{
            switch(operator.value){
                case "and":
                    return [
                        ...Array(8).keys()
                    ].map((i)=>bitsA.value[i] & bitsB.value[i]);
                case "or":
                    return [
                        ...Array(8).keys()
                    ].map((i)=>bitsA.value[i] | bitsB.value[i]);
        ...
        const decA = (0, _vue.computed)(()=>{
            return parseInt(bitsA.value.join(""), 2);
        });
        const decB = (0, _vue.computed)(()=>{
            return parseInt(bitsB.value.join(""), 2);
        });
        const decC = (0, _vue.computed)(()=>{
...
},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"b9ECB"}]},["4PXI3","gLLPy"], "gLLPy", "parcelRequire95f5")
